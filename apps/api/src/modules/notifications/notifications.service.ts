...
// In-app + email fan-out. The Notification row is the source of truth for
// the inbox; email is best-effort and must never fail the calling job.
// (Push delivery is added with the mobile milestone.)
